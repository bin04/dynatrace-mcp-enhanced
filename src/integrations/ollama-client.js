...
export class OllamaClient {
  ...
  async chat(message, context = null) {
    ...
    try {
      ...
      console.log(`🦙 Ollama query (${this.config.model}): ${message.substring(0, 100)}...`);
      console.log(`⏱️ Timeout set to: ${this.config.timeout}ms`);
  ...
  formatResponse(response, processingTime) {
    ...
    formatted += `\n\n💡 *Generated by ${this.config.model} in ${processingTime}ms*`;
